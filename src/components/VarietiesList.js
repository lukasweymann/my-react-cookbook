  ...
  if (fetchStatus === 'SUCCEEDED') {
    return (
      <div className="main-container-varieties-list">
        ...
        <p className='main-container-varieties-list__content'>Here's where you find all these little things you can get yourself to make coffee brewing an amazing, delicious experience. Made by yourself, with love.</p>
        <div className="varieties-list">
            ...
            {varietiesList.map(varieties => (
              <div className="varieties-card">
                ...
                <div className="info-variety-card">
                  <h1 className="info-variety-card__h1">{varieties.first_name}</h1>
